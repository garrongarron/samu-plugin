...
<div class="academy-widget-enroll__wishlist-and-share">
	<?php 
	// Agregar a mi lista de desados
	if($user_id):
	?>
		<button class="academy-btn academy-btn--bg-gray academy-add-to-wishlist-btn" data-course-id="<?php the_ID(); ?>" data-show-label="true">
	...
	<?php  endif; ?>
	<button class="academy-btn academy-btn--bg-white-border academy-share-button"><i class="academy-icon academy-icon--share"></i><?php esc_html_e( 'Share', 'academy' ); ?></button>
